...
<ol>
	<li>The <code><b>📄/_config.yml</b> file</code> will be initialized, all the configurations will be applied that were written in <code><b>📄/_config.yml</b> file</code></li>
	<li>
		<details>
